...
(* OASIS_START *)
(* DO NOT EDIT (digest: f1051f2e132ceb36003bd39b293d357d) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/batsh";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "utils_lib"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Bash_ast"; "Bash_compile"; "Bash_format"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\028º²w*ÎDËØ(\133æ\152á^'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
