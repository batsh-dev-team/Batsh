...
(* OASIS_START *)
(* DO NOT EDIT (digest: c4e5b6991a338112f77a5d75522efec8) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Parser"; "Bash"; "Winbat"];
                      lib_pack = true;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "batsh"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "óþ·H1\136Y§&Ú\020\138\145¸Ã2";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
