...
(* OASIS_START *)
(* DO NOT EDIT (digest: b99a89d356bc9faf77ac0068a21e88c4) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Batch_ast"; "Batch_compile"; "Batch_format"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "ÿ+uÇV\022¶²­£cz\029Ì\024\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
