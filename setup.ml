...
(* OASIS_START *)
(* DO NOT EDIT (digest: 33dcd58d8b09a8c35c1627b998bf4b9a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/BYVoid/Batsh";
          synopsis =
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "batsh_lib";
                           InternalLibrary "batsh_bash_lib";
                           InternalLibrary "batsh_winbat_lib"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/BYVoid/Batsh.git";
                      src_repo_browser =
                        Some "https://github.com/BYVoid/Batsh";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "x«\145il∂Î√∆\030~©Á4*G";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
